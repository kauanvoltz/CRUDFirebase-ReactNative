...
import { getFirestore,collection, addDoc,getDocs ,doc, updateDoc ,deleteDoc,where,query,QueryConstraint } from "firebase/firestore";
...
export{app,db, getFirestore,collection, addDoc,getDocs,doc, updateDoc,deleteDoc,where,query,QueryConstraint  }
